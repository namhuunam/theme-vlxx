...
<script src="/themes/vlxx/rating2/jquery.raty.js"></script>
<script>
    var rated = false;
    $('#star').raty({
        number: 10,
        starHalf: '/themes/vlxx/rating2/images/star-half.png',
        starOff: '/themes/vlxx/rating2/images/star-off.png',
        starOn: '/themes/vlxx/rating2/images/star-on.png',
